...
// Modified struct to include userRepo
...
// GetCharacter handles GET requests for a single character
...
// ListCharacters handles GET requests for all characters
...
func (c *CharacterController) CreateCharacter(w http.ResponseWriter, r *http.Request) {
	...
	// Add this check for user existence
	// Create a UserRepository to check if the user exists
	// We need to modify the function signature to accept a UserRepository
	if c.userRepo != nil {
...
// UpdateCharacter handles PUT requests to update an existing character
...
// DeleteCharacter handles DELETE requests to delete a character
